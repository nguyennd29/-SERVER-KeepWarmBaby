...
// const url = "https://api.apixu.com/v1/forecast.json?key=e51fc4c9af264ce69be71045182010&q='hanoi'&days=7";
// request.get(url, (err, res) => {
//   if (err) console.log(err);
//   else {
//     var forecast = JSON.parse(res.body).current.temp_c;
//   }
// });
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0">
                                  <tr>
                                    ...
                                    <td class="pt-10p plr-9p pb-8p">
                                      <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td class="fs-24 lh-28" align="center" style="padding:0 0 12px; font:700 40px/50px Arial, Helvetica, sans-serif; color:black;">
                                            <multiline>
                                              HANOI
                                            </multiline>
                                          </td>
                                        ...
                                        <tr>
                                          <td align="center" style="padding:0 0 5px; font:80px/160px Arial, Helvetica, sans-serif; color:black;">
                                            <multiline>
                                              ${forecast}<sup>o</sup>C  
                                            </multiline>
                                          </td>
                                        </tr>
                                        <tr>
